                    ...
                    <form wire:submit="login" class="mt-4">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input wire:model="form.email" type="email" class="form-control @error('form.email') is-invalid @enderror" placeholder="example@company.com" id="email" autofocus required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input wire:model="form.password" type="password" placeholder="Password" class="form-control @error('form.password') is-invalid @enderror" id="password" required>
                                </div>
